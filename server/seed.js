...
const seedDB = async () => {
  try {
    ...
    const adminUser = await User.create({
      ...
      bio: 'Antigravity\'s lead curator. Crafting articles that defy gravity and template norms.',
    ...
    const regularUser = await User.create({
      ...
      username: 'janedoe',
      password: 'password123',
      bio: 'Editorial designer and cultural observer. Interested in typography, minimalism, and slow journalism.',
  ...
  return complexity.filter(concept => concept.isEssential);
      ...
      },
      {
        ...
        `,
        coverImage: 'https://images.unsplash.com/photo-1506880018603-83d5b814b5a6?auto=format&fit=crop&w=1200&q=80',
        tags: ['culture'],
        author: adminUser._id,
        viewCount: 84,
        status: 'published',
    ...
    const commentsData = [
      {
        ...
        author: regularUser._id, // Jane Doe
        body: 'This is a great write-up on software craftsmanship. Less is truly more when it comes to code architecture and maintaining logic.'
      },
      {
        post: posts[0]._id, // The Gravity of Code
        author: adminUser._id, // Antigravity Admin
        body: 'Thank you Jane! Glad you found the gravity analogy resonant. Writing clean systems is a constant editing process.'
      },
      {
        post: posts[2]._id, // The Asymmetry of Editorial Layouts
        author: adminUser._id, // Antigravity Admin
        body: 'I absolutely love the asymmetric layout of this platform. It feels like flipping through a premium printed magazine rather than checking a database list.'
      },
      {
        post: posts[3]._id, // Fraunces vs. Inter
        author: regularUser._id, // Jane Doe
        body: 'Using a high-contrast serif typeface makes such a difference in reading comfort. It naturally tells the brain to slow down and absorb the words.'
      }
    ];
