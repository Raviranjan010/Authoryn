  ...
  if (error) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#F7F5F0] px-6 font-sans">
        <h2 className="text-2xl font-semibold font-serif text-[#111111] mb-2">Access Denied</h2>
        <p className="text-sm text-[#666666] font-light mb-6">{error}</p>
    ...
    <div className="min-h-screen bg-[#F7F5F0] pt-24 pb-20 px-6 font-sans">
      <div className="max-w-[720px] mx-auto">
        <div className="flex justify-between items-center pb-6 border-b border-[#111111]/15 mb-8">
          <div>
            <h1 className="text-3xl font-bold font-serif text-[#111111]">Edit Story</h1>
            <p className="text-xs text-[#666666] font-light">Modify your written draft or publication details.</p>
          </div>
